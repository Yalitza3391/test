...
namespace entity.Repositories
{
          ...
          where TContext : DbContext
    {
        ...
        public abstract IQueryable<TEntity> AllWithTracking();
        ...
        {
            return this.AllWithTracking().Where(predicate);
        }
        ...
        {
            return this.AllWithTracking().Select(predicate);
        }
        ...
        {
            return ((DbSet<TEntity>)this.AllWithTracking()).Find(keys);
        }


        public virtual Task<TEntity> FindAsync(CancellationToken token, params object[] keys)
        {
            return ((DbSet<TEntity>)this.AllWithTracking()).FindAsync(token, keys);
        }
        ...
        /// </summary>C:\APC\APC\Apc.Site\Apc.Site\Controllers\TXNSFileController.cs
        /// <param name="filters">
        /// A collection of filters.
        /// </param>
        /// <returns>
        ...
        {
            return this.AllWithTracking().Where(predicate).FirstOrDefault();
        }
        ...
        {
            return this.AllWithTracking().Where(predicate).FirstOrDefaultAsync();
        }
